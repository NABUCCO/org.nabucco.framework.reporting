 ...
 */
package org.nabucco.framework.reporting.facade.service.search;
...
/**
 * SearchReporting<p/>Reporting Search Service<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-11-09
 */
public interface SearchReporting extends Service {
     ...
     */
    ServiceResponse<ReportConfigurationListMsg> searchReportConfiguration(ServiceRequest<ReportConfigurationSearchRq> rq)
            throws SearchException;
}
