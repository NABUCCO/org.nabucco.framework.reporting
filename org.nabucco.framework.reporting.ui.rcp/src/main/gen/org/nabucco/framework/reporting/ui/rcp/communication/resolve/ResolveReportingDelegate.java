 ...
 */
package org.nabucco.framework.reporting.ui.rcp.communication.resolve;
...
public class ResolveReportingDelegate extends ServiceDelegateSupport {
     ...
     */
    public ReportConfigurationMsg resolveReportConfiguration(ReportConfigurationMsg message,
        ...
        throw new ClientException("Cannot execute service operation: ResolveReporting.resolveReportConfiguration");
    }
    ...
    public ReportConfigurationListMsg resolveReportConfigurationList(ReportConfigurationListMsg message,
        ...
        throw new ClientException("Cannot execute service operation: ResolveReporting.resolveReportConfigurationList");
    }
}
