...
/**
 * ResolveReportConfigurationServiceHandler<p/>Reporting resolution service<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-11-09
 */
public abstract class ResolveReportConfigurationServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.reporting.impl.service.resolve.ResolveReportConfigurationServiceHandler";

    /** Constructs a new ResolveReportConfigurationServiceHandler instance. */
    public ResolveReportConfigurationServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<ReportConfigurationMsg> invoke(ServiceRequest<ReportConfigurationMsg> rq)
        ...
        try {
            ...
            msg = this.resolveReportConfiguration(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ResolveException
     */
    protected abstract ReportConfigurationMsg resolveReportConfiguration(ReportConfigurationMsg msg)
            throws ResolveException;
