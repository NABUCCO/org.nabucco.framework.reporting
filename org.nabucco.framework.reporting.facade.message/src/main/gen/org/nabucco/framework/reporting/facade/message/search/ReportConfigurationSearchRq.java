 ...
 */
package org.nabucco.framework.reporting.facade.message.search;
...
/**
 * ReportConfigurationSearchRq<p/>Search message for ReportConfiguration search requests<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-11-09
 */
public class ReportConfigurationSearchRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new ReportConfigurationSearchRq instance. */
    public ReportConfigurationSearchRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(ReportConfigurationSearchRq.getPropertyDescriptor(REPORTTYPE),
                this.getReportType()));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ReportConfigurationSearchRq other = ((ReportConfigurationSearchRq) obj);
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(ReportConfigurationSearchRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ReportConfigurationSearchRq.class).getAllProperties();
    }
