 ...
 */
package org.nabucco.framework.reporting.ui.web.communication.reporting;
...
public class GenerateReportDelegate extends ServiceDelegateSupport {
     ...
     */
    public GenerateReportRs generateReport(GenerateReportRq message, NabuccoSession session,
            ServiceSubContext... subContexts) throws ReportingException {
        ServiceRequest<GenerateReportRq> request = new ServiceRequest<GenerateReportRq>(super.createServiceContext(
                session, subContexts));
        ...
        throw new ReportingException("Cannot execute service operation: GenerateReport.generateReport");
    }
}
